...
const Sidebar = ({ open, onClose, onAddNewOfferClick }) => {
  ...
  return (
    <Drawer className="sidebar" anchor="right" open={open} onClose={onClose} style={{ width: "320px" }}>
            ...
            <>
              ...
              <div className={`sidebar-user-section ${isDarkMode ? "dark-mode" : ""}`}>
                ...
                <div className={`sidebar-username-section ${isDarkMode ? "dark-mode" : ""}`}>
                  <span className="sidebar-username-section-username">John Doe</span>
                  <span className="sidebar-username-section-email">john@gmail.com</span>
                </div>
              </div>
            </>
          ) : (
